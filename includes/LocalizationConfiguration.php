...
class LocalizationConfiguration {
	public const DELETION_PROPOSE_CONFIGURATION = [ 'moduleEnabled' => false,
		'testMode' => false,
	...
	public const PAGE_PROTECTION_CONFIGURATION = [ 'moduleEnabled' => false,
		'testMode' => false,
		'protectionDurations' => [ [ 'value' => 'temporary',
			'data' => 'Temporary',
			'label' => 'Temporary' ],
			[ 'value' => 'indefinite',
				'data' => 'Indefinite',
				'label' => 'Indefinite' ] ],
		'protectionTypes' => [ [ 'value' => 'semi-protection',
	...
	public const SPEEDY_DELETION_REQUEST_CONFIGURATION = [ 'moduleEnabled' => false,
		'testMode' => false,
		'speedyDeletionReasons' => [ [ 'name' => 'Articles',
			'namespace' => 0,
			'reasons' => [ [ 'namespace' => 0,
				'value' => 'A1',
			...
			[ 'name' => 'Categories',
				'namespace' => 14,
				'reasons' => [ [ 'data' => '[[WP:CSD#C1|CSD:C1]]: Test category',
					'value' => 'C1',
					'selected' => false,
			...
			[ 'name' => 'User pages',
				'namespace' => 2,
				'reasons' => [ [ 'data' => '[[WP:CSD#U1|CSD:U1]]: Test user page',
					'value' => 'U1',
					'selected' => false,
			...
			[ 'name' => 'Templates',
				'namespace' => 10,
				'reasons' => [ [ 'data' => '[[WP:CSD#T1|CSD:T1]]: Test template',
					'value' => 'T1',
					'selected' => false,
			...
			[ 'name' => 'Portals',
				'namespace' => 100,
				'reasons' => [ [ 'data' => '[[WP:CSD#T1|CSD:P1]]: Test portal',
					'value' => 'P1',
					'selected' => false,
			...
			[ 'name' => 'General',
				'namespace' => 'general',
				'reasons' => [ [ 'data' => '[[WP:CSD#G1|G1]]: [[WP:PN|Patent nonsense]], meaningless, or incomprehensible',
					'value' => 'G1',
					'selected' => false,
			...
			[ 'name' => 'Redirects',
				'namespace' => 'redirect',
				'reasons' => [ [ 'data' => '[[WP:CSD#R1|CSD:R1]]: A test redirect',
					'value' => 'R1',
					'selected' => false,
			...
			[ 'name' => 'Other',
				'namespace' => 'other',
				'reasons' => [ [ 'data' => '[[Other|other]]: reason',
					'value' => '01',
					'selected' => false,
					'label' => 'Other reason',
					'namespace' => 'other',
	...
	public const PAGE_MOVE_CONFIGURATION = [ 'moduleEnabled' => false,
		'testMode' => false,
	...
	public const ARTICLE_TAGGING_CONFIGURATION = [ 'moduleEnabled' => false,
		'testMode' => false,
		'tagList' => [ [ 'label' => 'Cleanup and maintenance',
			'tags' => [ [ 'tag' => 'Cleanup',
	...
	public const CONFIGURATION_MAP = [ 'deletion_propose' => self::DELETION_PROPOSE_CONFIGURATION,
