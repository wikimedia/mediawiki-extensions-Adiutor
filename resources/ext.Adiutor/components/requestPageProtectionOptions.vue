...
<template>
	...
	<cdx-field>
		<table id="adiutor-options-props" width="100%">
			<caption>
				{{ $i18n( 'adiutor-protection-durations' ) }} <cdx-button
	...
	<cdx-field>
		<table id="adiutor-options-props" width="100%">
			<caption>
				{{ $i18n( 'adiutor-protection-types' ) }} <cdx-button
					class="add-new-button"
					weight="quiet"
...
const { CdxMessage, CdxTextInput, CdxChipInput, CdxToggleSwitch, CdxButton, CdxField, CdxRadio, CdxTextArea } = require( '@wikimedia/codex' );
