...
<template>
	...
	<cdx-field>
		...
		<cdx-label input-id="copyVioReasonValue">
			{{ $i18n( 'adiutor-copy-vio-reason-value' ) }}
		</cdx-label>
		<cdx-text-input
			id="copyVioReasonValue"
			v-model="copyVioReasonValue"
	...
	<cdx-field>
		<table id="adiutor-options-props" width="100%">
			<caption>
				{{ $i18n( 'adiutor-speedy-deletion-reasons' ) }} <cdx-button
...
const { CdxMessage, CdxTextInput, CdxChipInput, CdxToggleSwitch, CdxField, CdxRadio, CdxButton } = require( '@wikimedia/codex' );
